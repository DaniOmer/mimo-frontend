<template>
  <div class="p-6">
    ...
    >
      <!-- Contrôles du tableau (recherche et filtres) -->
        ...
        <div class="flex flex-wrap gap-4 items-center justify-between w-full">
          ...
          <div class="flex flex-wrap gap-4 items-center">
            ...
            <FilterSelect
              ...
              placeholder="Filtrer par Fonctionnalité"
              :isMultiple="false"
              class="w-48"
            />
      ...
      <!-- Colonne personnalisée pour les plages de prix -->
      ...
      <!-- Colonne personnalisée pour les catégories -->
      ...
      <!-- Colonne personnalisée pour les fonctionnalités -->
...
// Sélection multiple de produits pour les actions en masse
...
// Computed Property pour passer le bon type à `productData`
...
// Filtrage des produits en fonction des filtres et de la recherche
...
// Fonctions pour récupérer les noms des catégories et des fonctionnalités
...
// Produits ciblés pour les actions de confirmation
...
// Label dynamique pour le bouton de soumission du formulaire
const formSubmitLabel = computed(() =>
  productToEdit.value ? "Mettre à jour" : "Créer"
);

// Fonctions de gestion des filtres et de la recherche
function handleSearch(query: string) {
  searchQuery.value = query;
}

// function handleCategoryChange(selected: string | null) {
//   selectedCategory.value = selected;
// }

// function handleFeatureChange(selected: string | null) {
//   selectedFeature.value = selected;
// }

// function handleStatusChange(selected: string | null) {
//   selectedStatus.value = selected;
// }

// Fonctions pour ouvrir et fermer les modaux
...
// Gestion de la soumission du formulaire de création/édition
async function handleFormSubmit(formData: any) {
  ...
  try {
    if (productToEdit.value) {
      ...
      await productStore.updateProductWithVariants(productToEdit.value._id, 
      product,
      variants,
      );
...
// Confirmation et suppression d'un produit
...
// Confirmation et désactivation d'un produit
...
// Confirmation et activation d'un produit
...
// Actions en masse : suppression multiple de produits
...
// Mise à jour des produits sélectionnés pour les actions en masse
